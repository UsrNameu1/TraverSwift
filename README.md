...
A thin framework for swift's Collection effected by [Scala's Traversable](http://www.scala-lang.org/api/current/index.html#scala.collection.Traversable) & [Haskell's Data.List](http://hackage.haskell.org/package/base-4.7.0.2/docs/Data-List.html)
