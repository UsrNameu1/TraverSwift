...
- [Gallery](#Gallery)
   ...
   - [Special element SequenceType](#Special element SequenceType)
      - [sum & product function for ArithmeticType element](#sum & product function for IntegerArithmeticType or FloatingArithmeticType(Custom protocol) element)
   ...
   - [Array](#Array)
      - [existsAny & existsAll function](#existsAny & existsAll function (for array which has element of Optional\<T\>))  
      - [concat function](#concat function for array of array) 
